          ...
          <div className="w-full flex gap-6">
            <div className="w-[70%] flex flex-col gap-4">
              <div className="w-full rounded-md p-5 flex justify-between items-center border-2 ">
                ...
                <button
                  ...
                  className="text-[14px] w-[14%] p-2 px-4 border-2 rounded-md transition-all duration-500 hover:bg-white hover:bg-opacity-35"
                >
                  Manage
                </button>
                <Dialog
              ...
              <div className="w-full rounded-md p-5 flex justify-between items-center border-2 ">
                ...
                <button
                  onClick={logout}
                  className="text-[14px] w-[14%] rounded-md p-2 px-4 transition-all duration-500 border-2 hover:bg-white hover:bg-opacity-35"
                >
                  Sign out
                </button>
              </div>
            ...
            <div className="flex flex-col items-center border-2 p-4 rounded-md w-[30%]">
              ...
              <div className="flex flex-col items-center justify-center py-10 h-[50%] gap-4">
                <button className="text-[16px] border p-2 px-4 rounded-md hover:bg-white hover:bg-opacity-30 transition-all duration-500">
                  View plans &#8594;
                </button>
